...
const songsByArtist = {
    ...
    'All': [
      { title: 'Aabaad Barbaad', src: '/arijit/Aabad_Barbaad.mp3' },
      { title: 'Baatein ye kabhi na', src: '/ariji/Baatein_Ye_Kabhi_Na.mp3' },
      { title: 'Kesariya', src: '/arijit/Kesariya.p3' },
      { title: 'Tere Hawaale', src: '/arijit/Tere_awaale.mp3' },
      { title: 'Tu Hai To Mujhe ', src: '/arijit/T_Hai_to_Mujhe.mp3' },
      { title: 'Woh Din', src: '/arijit/Woh_Din.mp' },
      { title: 'Hawa_Banke', src: '/darshan/Hawa_Bnke.mp3' },
      { title: 'Mere Mahiye Jinna Sona', src: 'son1.mp3' },
      { title: 'Saari_Ki_Saari_2.0', src: '/darsha/Saari_Ki_Saari_2.0.mp3' },
      { title: 'Tere_Naal', src: '/darshan/Tere_Nal.mp3' },
      { title: 'Teri_Aankhon_Mein', src: '/darshanTeri_Aankhon_Mein.mp3' },
      { title: 'Tu_Mileya', src: '/darshan/Tu_Milea.mp3' },
      { title: 'Besabriyaan', src: '/arman/Besabriaan.mp3' },
      { title: 'Dil_Ke_Pass', src: '/arman/Dil_K_ass.mp3' },
      { title: 'Jaane_Na_Dunga_Kahin', src: '/ama/Jaane_Na_Dunga_Kahin.mp3' },
      { title: 'Jab_Tak', src: '/arman/Jab_Takmp3' },
      { title: 'Kyun_Rabba', src: '/arman/KyunRabba.mp3' },
      { title: 'Mujhe_Pyaar_Pyaar_Hai', src: '/arman/Muhe_Pyaar_Pyaar_Hai.mp3' },
      { title: 'Dj_Waley_Babu', src: '/badsha/Dj_WaleyBabu.mp3' },
      { title: 'Fly', src: '/badsha/Fl.mp3' },
      { title: 'Garmi', src: '/badsha/armi.mp3' },
      { title: 'Genda_Phool', src: '/bdsha/Genda_Phool.mp3' },
      { title: 'Jugnu', src: '/badsha/ugnu.mp3' },
      { title: 'Kamaal_Hai', src: '/basha/Kamaal_Hai.mp3' },
      { title: 'Sanak', src: '/badsha/anak.mp3' },
      { title: 'Baarish_Ki_Jaaye', src: '/bprak/Baaish_Ki_Jaaye.mp3' },
      { title: 'Dil_Tod_Ke', src: '/bprak/Dil_Tod_K.mp3' },
      { title: 'Kya_Loge_Tum', src: '/bprak/Kya_Log_Tum.mp3' },
      { title: 'Mann_Bharrya_2.0', src: '/bprak/Man_Bharrya_2.0.mp3' },
      { title: 'Meri_Jaan_Meri_Jaan', src: '/bprak/eri_Jaan_Meri_Jaan.mp3' },
      { title: 'Ranjha', src: '/bprak/Ranja.mp3' },
      { title: 'Backbone', src: '/hardy/Bakbone.mp3' },
      { title: 'Bijlee_Bijlee', src: '/hary/Bijlee_ijlee.mp3' },
      { title: 'Kyaa_Baat_Haii_2.0', src: '/hardy/Kaa_Baat_Haii_2.0.mp3' },
      { title: 'Naah', src: '/hardy/Naah.p3' },
      { title: 'Titliyaan_Warga', src: '/ardy/Titliyaan_Warga.mp3' },
      { title: 'Jaadui', src: '/jubin/Jaaui.mp3' },
      { title: 'Lut_Gaye', src: '/jubin/Lt_Gaye.mp3' },
      { title: 'Mere_Ghar_Ram_Aaye_Hain', src: '/jubin/Mere_Ghr_Ram_Aaye_Hain.mp3' },
      { title: 'Meri_Maa_Ke_Barabar_Koi_Nahi', src: '/jubin/Mi_Maa_Ke_Barabar_Koi_Nahi.mp3' },
      { title: 'Rattan_lambiyan', src: '/jubin/Ratan_lambiya.mp3' },
      { title: 'Rim_Jhim', src: '/jubin/Rim_Jhim.p3' },
      { title: 'Shri_Krishna_Govind', src: '/jubi/Shri_Krishna_Govind.mp3' },
      { title: 'Toh_Aagaye_Hum', src: '/jubin/TohAagaye_Hum.mp3' },
      { title: 'Daaru_Party', src: '/mg/Daaru_Pary.mp3' },
      { title: 'Main_Teri_Ho_Gayi', src: '/mg/Mai_Teri_Ho_Gayi.mp3' },
      { title: 'Naam', src: '/mg/Naammp3' },
      { title: 'Nazar_Lag_Jayegi', src: '/mNazar_Lag_Jayegi.mp3' },
      { title: 'Shanti', src: '/mg/Shanti.m' },
      { title: 'She_Dont_Know', src: '/mg/Se_Dont_Know.mp3' },
      { title: 'Sohnea', src: '/mg/Sohnea.m3' },
     { title: 'Dil_Ko_Karaar_Aaya', src: '/neha/il_Ko_Karaar_Aaya.mp3' },
     { title: 'Nehu_Da_Vyah', src: '/neha/Nehu_D_Vyah.mp3' },
     { title: 'Chura_Liya', src: '/sachet/Chura_iya.mp3' },
     { title: 'Jind_Meriye', src: '/sachet/Jind_eriye.mp3' },
     { title: 'Malang_Sajna', src: '/sachet/Malag_Sajna.mp3' },
      { title: 'Ram_Siya_Ram_2.0', src: '/sachet/am_Siya_Ram_2.0.mp3' },
      { title: 'Takdaa_Rawaan', src: '/sachet/Takaa_Rawaan.mp3' },
    ],
...
function checkPromoCode() {
    ...
    if (promoCode === '2952' || promoCode === '3011') {
        ...
        // Add your code here to allow the user to continue on the website
    } else {
